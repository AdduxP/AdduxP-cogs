...
class Chat():
    ...
    def __init__(self, bot):
        self.bot = bot
        self.clv = _Cleverbot('Oberon-DiscordBot')
    ...
    async def toggle(self):
        ...
        if self.settings["TOGGLE"]:
            await self.bot.say("I'll start replying on mention.")
        else:
    ...
    async def get_response(self, msg):
        ...
        try:
            ...
            answer = "Oops, my brain's dead! We'll talk later..."
        return answer
...
def setup(bot):
    if _Cleverbot is False:
        raise RuntimeError("Your cleverbot library is either missing or not "
                           ...
                           "and restart me once you get a response.\n"
